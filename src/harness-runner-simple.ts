#!/usr/bin/env node
/**
 * Harness runner — builds and evaluates ramp constants.
 * Usage: npx tsx src/harness-runner.ts
 * (or: npx esbuild src/harness-runner.ts --bundle --platform=node --outfile=/tmp/harness.js && node /tmp/harness.js)
 */
